...
https://github.com/metamolecular/inchi/blob/master/INCHI_API/demos/python_sample/yapyinchi.py
...
def load_inchi_library(path):
    ...
    if (platform=="Windows"):
        ...
        libname = path + "/libinchi.so" #"/usr/lib/libinchi.so.1"
    else:
        return None
    #
    print (libname)
